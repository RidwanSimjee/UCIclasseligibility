...
class PrerequisiteTree(unittest.TestCase):
    ...
    def test_multiple_courses_in_and_structure(self):
        main.prereq_set.clear()
        main.prereq_set.update(('testclassone', 'testclasstwo', 'testclassthree', 'testclassfour'))
    ...
    def test_nested_and_structure(self):
        ...
        main.prereq_set.add('I&C SCI 61')
        self.assertFalse(main.recursive_prerequisite_breakdown({"AND": ["I&C SCI 33", "I&C SCI 61", {"AND": ["MATH 3A", "I&C SCI 6N"]}]}))
        main.prereq_set.add('I&C SCI 33')
        self.assertFalse(main.recursive_prerequisite_breakdown({"AND": ["I&C SCI 33", "I&C SCI 61", {"AND": ["MATH 3A", "I&C SCI 6N"]}]}))
        main.prereq_set.add('MATH 3A')
        self.assertFalse(main.recursive_prerequisite_breakdown({"AND": ["I&C SCI 33", "I&C SCI 61", {"AND": ["MATH 3A", "I&C SCI 6N"]}]}))
        main.prereq_set.add('I&C SCI 6N')
    ...
    def test_multiple_courses_in_or_structure(self):
        main.prereq_set.clear()
        main.prereq_set.update(('testclassone', 'testclasstwo', 'testclassthree'))
